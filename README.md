...
Развёрнут в K3s‑кластере, использует PostgreSQL, Redis, Celery, Nginx. Полноценный CI/CD через GitHub Actions или GitLab.
...
В большинстве случаев миграции применяются через CI/CD. Для локальной разработки достаточно двух команд выше.
---
...
- **`fastapi/README.md`** — документация FastAPI приложения (архитектура, структура, тестирование)
