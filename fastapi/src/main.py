...
- **Управление отелями и номерами**: Создание, обновление, удаление отелей и номеров с удобствами. Поиск отелей с доступными номерами на заданный период
- **Система бронирований**: Создание бронирований с автоматическим расчетом цены, просмотр и отмена своих бронирований
- **Географическая структура**: Управление странами и городами для организации поиска отелей по локации
- **Управление пользователями**: Регистрация, аутентификация через JWT токены с refresh механизмом, управление профилем
- **Загрузка изображений**: Обработка и хранение изображений отелей через Celery с автоматическим созданием ресайзов
